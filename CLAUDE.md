...
`PROJECT_AESTHETICS.md`

This project uses a highly specific **Survival Horror & Biopunk** aesthetic. The aesthetic rules outlined in `PROJECT_AESTHETICS.md` are mandatory and supersed any generic or standard "clean tech" UI designs. 
